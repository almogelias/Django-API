...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        # check if password of created user is correct.
        self.assertTrue(user.check_password(payload['password']))
        # check if password not in response data - there is no password ket in the res data
